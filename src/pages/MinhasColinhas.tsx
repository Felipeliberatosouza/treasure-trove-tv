    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <div className="flex-1 px-6 pt-24 pb-12 md:px-16 lg:px-32">
        <div className="mx-auto max-w-5xl space-y-8">
          ...
          <p className="text-muted-foreground text-lg">Suas colinhas e anotações rápidas.</p>
          <div className="rounded-xl border border-border bg-card p-12 text-center">
            <StickyNote className="mx-auto h-12 w-12 text-muted-foreground/40 mb-4" />
            <p className="text-muted-foreground">Você ainda não criou nenhuma colinha.</p>
          </div>
        </div>
      </div>
      <Footer />
