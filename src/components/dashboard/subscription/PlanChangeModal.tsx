          ...
          <div className="space-y-2">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                >
                  {proRata >= 0 ? <CreditCard className="h-5 w-5" /> : <Wallet className="h-5 w-5" />}
                </div>
                <div className="flex-1 min-w-0">
                  <p className={`text-xs font-medium uppercase tracking-wider ${
                    ...
                    {proRata >= 0 ? "Valor a pagar agora" : "Crédito a seu favor"}
                  </p>
              ...
              <p className="text-xs text-muted-foreground mt-2">
                {proRata >= 0
                  ? `Diferença proporcional pelos ${remainingDays} dias restantes do ciclo. A partir da próxima renovação: R$ ${selectedPlan.price.toFixed(2)}/mês.`
                  : `Crédito aplicado na próxima fatura. A partir da próxima renovação: R$ ${selectedPlan.price.toFixed(2)}/mês.`
                }
              </p>
            </div>
