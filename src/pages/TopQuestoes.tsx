    ...
    <div className="flex-1 px-6 pt-24 pb-12 md:px-16 lg:px-32">
      <div className="mx-auto max-w-5xl space-y-8">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-display text-3xl font-bold text-gradient">Top Questões de Provas</h1>
        </div>
        <p className="text-muted-foreground text-lg">As questões mais cobradas nas principais provas.</p>
