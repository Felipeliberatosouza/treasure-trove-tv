  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-xs text-muted-foreground">
        Variáveis disponíveis: {"{{platform_name}}"}, {"{{razao_social}}"}, {"{{nome_fantasia}}"}, {"{{cnpj}}"}, {"{{platform_address}}"}, {"{{teacher_name}}"}, {"{{teacher_cpf}}"}, {"{{teacher_address}}"}, {"{{teacher_pix}}"}, {"{{teacher_percentage}}"}, {"{{teacher_percentage_text}}"}, {"{{platform_percentage}}"}, {"{{platform_percentage_text}}"}, {"{{data}}"}, {"{{hora}}"}
      </p>
