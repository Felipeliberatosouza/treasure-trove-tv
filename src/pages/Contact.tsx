              ...
              {(contact?.instagram || contact?.youtube || contact?.facebook || contact?.twitter || contact?.tiktok || contact?.linkedin || contact?.whatsapp) && (
                <div className="pt-3 border-t border-border space-y-2">
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    {contact.whatsapp && (
                      <a href={`https://wa.me/${contact.whatsapp.replace(/\D/g, "")}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-sm text-primary hover:underline">
