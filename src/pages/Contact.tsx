              ...
              {(contact?.instagram || contact?.youtube || contact?.facebook || contact?.twitter || contact?.tiktok || contact?.linkedin || contact?.whatsapp) && (
                <div className="pt-3 border-t border-border space-y-2">
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    {contact.whatsapp && (
                      <WhatsAppLeadLink href={`https://wa.me/${contact.whatsapp.replace(/\D/g, "")}${contact.whatsapp_message ? `?text=${encodeURIComponent(contact.whatsapp_message)}` : ""}`} source="contato" className="flex items-center gap-1.5 text-sm text-primary hover:underline">
