    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <div className="flex-1 px-6 pt-24 pb-12 md:px-16 lg:px-32">
        <div className="mx-auto max-w-5xl space-y-8">
          ...
          <p className="text-muted-foreground text-lg">Acompanhe suas revisões salvas e em andamento.</p>
          <div className="rounded-xl border border-border bg-card p-12 text-center">
            <BookOpen className="mx-auto h-12 w-12 text-muted-foreground/40 mb-4" />
            <p className="text-muted-foreground">Você ainda não possui revisões salvas.</p>
          </div>
        </div>
      </div>
      <Footer />
