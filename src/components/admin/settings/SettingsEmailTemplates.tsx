...
const TEMPLATE_LABELS: Record<string, string> = {
  ...
  password_changed_admin: "Senha Alterada pelo Suporte",
  ...
  doubt_question_approved: "Dúvida Aprovada (Aluno)",
...
const TEMPLATE_DESCRIPTIONS: Record<string, string> = {
  ...
  password_changed_admin: "Enviado ao usuário quando um administrador define uma nova senha para a conta dele pelo painel. Orienta a entrar em contato com o suporte caso não tenha solicitado a alteração.",
  ...
  doubt_question_approved: "Enviado ao aluno quando sua dúvida é aprovada pelo administrador e encaminhada ao professor.",
...
const TEMPLATE_VARS: Record<string, string[]> = {
  ...
  password_changed_admin: ["{{name}}", "{{platform_name}}", "{{support_email}}", "{{support_whatsapp}}", "{{changed_at}}"],
  ...
  doubt_question_approved: ["{{student_name}}", "{{question}}"],
