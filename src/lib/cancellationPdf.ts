...
export function buildCancellationPdf(data: CancellationPdfData): jsPDF {
...
export function downloadCancellationPdf(data: CancellationPdfData, filename?: string) {
  const doc = buildCancellationPdf(data);
