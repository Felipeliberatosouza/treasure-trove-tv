...
import type { ContactSettings } from "@/hooks/usePlatformSettings";
...
const WhatsAppFloat = () => {
  ...
  const message = contact?.whatsapp_message ? `?text=${encodeURIComponent(contact.whatsapp_message)}` : "";

  return (
    <WhatsAppLeadLink
      href={`https://wa.me/${cleanNumber}${message}`}
